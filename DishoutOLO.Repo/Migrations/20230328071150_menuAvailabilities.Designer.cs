...
namespace DishoutOLO.Repo.Migrations
{
    ...
    [Migration("20230328071150_MenuAvailabilities")]
    partial class MenuAvailabilities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DishoutOLO.Data.MenuAvailabilities", b =>
                {
                    ...
                    b.Property<string>("daysList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("utC_FromTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("utC_ToTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DishoutOLO.Data.Menu", b =>
                {
                    ...
                    b.HasOne("DishoutOLO.Data.Program", "Program")
                        .WithMany()
            ...
            modelBuilder.Entity("DishoutOLO.Data.MenuAvailabilities", b =>
                {
                    b.HasOne("DishoutOLO.Data.Menu", "Menu")
                        .WithMany()
